  ...
  [init]() {
    co(function* () {
      ...
      if (server) {
        ...
        this[logger].info('[ClusterClient#%s] has seized port %d, and serve as leader client.', name, port);
      } else {
        this[innerClient] = new Follower(this._options);
        this[logger].info('[ClusterClient#%s] give up seizing port %d, and serves as follower client.', name, port);
      }
